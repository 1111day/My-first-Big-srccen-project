  ...
  <div class="home">
        ...
        <defs>
            ...
            <filter
              ...
              filterUnits="userSpaceOnUse"
            >
                              <!-- stdDeviation高斯模糊 SourceAlpha 透明度  -->
              <feGaussianBlur result="blur" stdDeviation="6.667" in="SourceAlpha" />
              <feComposite result="composite" />
              <feComposite result="composite-2" />
              <feComposite result="composite-3" />
            ...
            <g id="right">
              <g id="组_380" data-name="组 380">
                ...
                <template v-for="item in [1,2,3]" :key="item">
                            <circle id="dots-blue" class="cls-blue" cx="0" cy="0" r="3">
                                <animateMotion dur="5.4s" begin="0s" repeatCount="indefinite" rotate="auto">
                                    <mpath :href="`#line_b_${item}`"></mpath>
                                </animateMotion>
                          </circle>
                          <circle id="dots-blue" class="cls-blue" cx="0" cy="0" r="3">
                                <animateMotion dur="5.4s" begin="-3s" repeatCount="indefinite" rotate="auto">
                                    <mpath :href="`#line_b_${item}`"></mpath>
                                </animateMotion>
                          </circle>
                </template>
                <!-- 如法炮制3根黄线6个黄色原点同上面做法相似 -->
                <template v-for="item in [1,2,3]" :key="item">
                          <circle id="dots-orge" class="cls-organ" cx="0" cy="0" r="3">
                              <animateMotion dur="5.5s" begin="0s" repeatCount="indefinite" rotate="auto">
...
<style scoped>
              ...
              /* 图片上下移动的动画 */
              #icon_star_guangzhou,#icon_location_zhongshan,#icon_hot_zhuhai{
                animation: updown 2.2s ease-in infinite;
              }
              #icon_pie_shenzhen,#icon_home_foshan,#icon_earth_dongguan{
